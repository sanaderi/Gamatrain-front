                        ...
                        <v-slide-x-transition v-if="enableStep1Txt">
                            <div class="vision-step">
                                ...
                                <p class="gama-text-body2">
                                    We understand that every student has their own unique learning style and preferences.
                                    That's
                                    why we're working on integrating AI into our platform to offer personalized learning
                                    paths
                                    that adapt to each student's needs. With customized learning paths, students can learn
                                    at
                    ...
                    <v-col cols="12" md="4">
                        <v-slide-x-transition v-if="enableStep2Txt">
                            <div class="vision-step">
                                ...
                                <p class="gama-text-body2">
                                    We recognize the importance of environmental sustainability and the role education plays
                                    in
                                    creating a better future. We are committed to promoting a green economy by offering
                                    courses
                        ...
                        <v-slide-x-transition v-if="enableStep3Txt">
                            <div class="vision-step">
                                ...
                                <p class="gama-text-body2">
                                    ...
                                    remains accurate, relevant, and up-to-date. By decentralizing content quality
                                    moderation, we
                ...
                <v-col cols="12">
                    ...
                    <v-sheet class="mx-auto ">
                        <div class="d-flex memberSliderContainer">
                            <div v-for="(member, index) in sliceTeamMember" @click="slideClicked(index)">
                        ...
                        <v-row id="active-user-data">
                            <v-col cols="12">
                                <h5 class="gama-text-h5">{{ teamMembers[activeMember + tmpShowMemeber].fullName }}</h5>
        ...
        <v-container id="about-join-us">
            <v-row>
                <v-col cols="12">
                    ...
                    <p class="gama-text-body1">
                        Join Us and become part of the GamaTrain community! We're always looking for talented individuals
                        who are passionate about EdTech and want to make a positive impact in the world of education.
                    </p>
                </v-col>
            </v-row>
        </v-container>
    ...
    methods: {
        ...
        initIntersectionObserver() {
            ...
            if (window.innerWidth > 960)
                ...
                observer.observe(this.$refs.mobileStepProgressBar);

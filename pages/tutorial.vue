...
<!--                        <img :src="require('assets/images/' + item.lesson_pic)" alt="" width="65"-->
<!--                             height="90">-->
                      </div>
                    </v-col>
                  ...
                  <div class="tutorial-item-footer d-flex mt-2">
                    <div class="item-content-user d-flex align-center mr-2">
<!--                      <img :src="require('@/assets/images/' + item.avatar)" alt="" width="25">-->
                      <p class="mx-2">{{ item.first_name }} {{item.lastname}}</p>
                    </div>
                    <div class="item-content-last-update d-flex align-center mx-auto">
                      <i class="fa-solid fa-calendar-days"></i>
                      <p class="mx-2">confirm date : {{ item.up_date }}</p>
                    </div>
                  </div>
                </div>
              </div>

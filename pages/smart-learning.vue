    ...
    <div>
        ...
        <v-container fluid id="service-comprehensive-curriculum">
            <v-container>
                <v-row>
                    <v-col md="6">
                        <h2 class="gama-text-md-4 white--text mb-2">Empowering Smart Learning!</h2>
                        <p class="gama-text-md-body1 white--text">
        ...
        <v-container id="service-smart-assistance">
            <v-row>
                ...
                <v-col md="6">
                    <h2 class="gama-text-md-h4 mb-2">
                        24/7 Smart Assistance
                    </h2>
                    <p class="gama-text-md-body1">
        ...
        <v-container fluid id="service-progress-tracking">
            <v-container>
                <v-row>
                    <v-col md="6">
                        <h2 class="gama-text-md-h4 mb-2">Real-Time Progress Tracking</h2>
                        <p class="gama-text-md-body1">

<template>
 <div class="last-files pa-4 ">
   <div class="lastfile-content d-flex flex-column">
     ...
     <div class="d-none d-md-flex date-name  align-center justify-space-between mt-5">
     ...
     <div class="date-name d-none d-md-flex align-center justify-space-between my-5">
       <p>Content:{{ lastFile.content }}</p>
       <p> Budgeting: {{ lastFile.budget }}</p>
     </div>
   </div>
   <div class="d-flex d-md-none date-name  align-center justify-space-between mt-3">
     <div class="d-flex align-center">
       <img :src="require('@/assets/images/' + lastFile.img)" alt="">
       <p class="ml-2">{{ lastFile.name }}</p>
     </div>
